...
const ProjectCardLarge = ({topic, link, skills, description}) => {
  return (
    <div className="h-[29rem] md:h-[34rem] w-full flex items-center justify-center transform transition-transform duration-500 hover:scale-105 hover:shadow-lg border border-gray-500 p-3 rounded-2xl md:hidden lg:hidden">
